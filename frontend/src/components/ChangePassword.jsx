...
export default function ChangePassword() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-black to-gray-900">
      <div className="bg-slate-900 shadow-md rounded-lg p-6 w-full max-w-md">
        <h2 className="text-xl font-bold text-center mb-4 text-white">Change Password</h2>

        <label className="block mb-2 font-semibold text-white">User Type</label>
        <select name="userType" value={userType} onChange={onChange}
          className="w-full border-blue-500 bg-slate-700 text-white px-3 py-2 rounded mb-4 ">
          <option>Admin</option>
        ...
        <input type="email" name="email" value={email} onChange={onChange}
          className="w-full border-blue-500 bg-slate-700 text-white px-3 py-2 rounded mb-4" required />

        <label className="block mb-2 font-semibold text-white">New Password</label>
        <input type="password" name="newPassword" value={newPassword} onChange={onChange}
          className="w-full border-blue-500 bg-slate-700 text-white px-3 py-2 rounded mb-4" required />

        <label className="block mb-2 font-semibold text-white">Confirm Password</label>
